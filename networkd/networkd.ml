...
let options = [
	...
	"pciback-unbind-interface", Arg.Set_string Network_utils.pciback_unbind_interface, (fun () -> !Network_utils.pciback_unbind_interface), "Interface path to unbind device from pciback driver";
	"pciback-remove-slot-interface", Arg.Set_string Network_utils.pciback_remove_slot_interface, (fun () -> !Network_utils.pciback_remove_slot_interface), "Interface path to remove device from pciback slots";
]
